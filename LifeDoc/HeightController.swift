...
class HeightContoller: UIViewController, WWCalendarTimeSelectorProtocol  {
    ...
    override func viewDidLoad() {
        ...
        self.navItem.title = "Edit Height"
        idHeight = "0"
    ...
    private func deleteRecord() {
        ...
        HeightContoller.Manager.request(urlString, method: .post, parameters: parameters, encoding: JSONEncoding.default,headers: headers).responseJSON { response in
...
extension HeightContoller: TextFieldDelegate {
