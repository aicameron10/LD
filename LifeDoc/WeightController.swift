...
class WeightContoller: UIViewController, WWCalendarTimeSelectorProtocol  {
    ...
    override func viewDidLoad() {
        ...
        self.navItem.title = "Edit Weight"
        idWeight = "0"
    ...
    private func prepareCloseButton() {
        ...
        leftNavItem?.action = #selector(WeightContoller.buttonTapActionClose)
    ...
    func textFieldDidChangeweightLength(textField: UITextField) {
        ...
        checkMaxLength(textField: weight,maxLength: 6)
    ...
    private func deleteRecord() {
        ...
        WeightContoller.Manager.request(urlString, method: .post, parameters: parameters, encoding: JSONEncoding.default,headers: headers).responseJSON { response in
...
extension WeightContoller: TextFieldDelegate {
